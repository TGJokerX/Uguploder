...
# API Configuration
API_ID = int(os.environ.get("API_ID", "24497147"))
API_HASH = os.environ.get("API_HASH", "350b3b383bd453a2060d9dcccb9e31cb")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7345439554:AAHBDP5LDdvPolHnf6v6ENwmEHTbRojDZXU")

CREDIT = os.environ.get("CREDIT", "『 𝗧𝗚𝗝ᴏᴋᴇʀ𝗫 🎭』")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "8176451634"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "8176451634").split()]  # Default to owner ID
